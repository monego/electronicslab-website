...
router.register('componentes', views.ComponenteViewSet, basename='componentes')
router.register('componentes-publico', views.ComponentePublicoViewSet, basename='componentes-publico')
